==============================
Claude Code /qr 스킬 사용법
==============================

Claude Code에서 ``/qr`` 커맨드를 사용하면 URL을 QR 코드로 빠르게 생성하고 클립보드에 복사할 수 있습니다.
...
예시::
    ...
    /qr https://forms.gle/abc123

실행하면 다음이 자동으로 수행됩니다:

1. 입력한 URL로 QR 코드 이미지(``QR_output.png``)를 생성합니다.
2. 생성된 이미지를 클립보드에 복사합니다.
3. QR 코드 이미지를 화면에 보여줍니다.
